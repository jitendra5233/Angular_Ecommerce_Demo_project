...
videoPopup.magnificPopup({
    ...
    //     var quantityContainer = document.querySelector('.product-quantity');
    //     var decrementButton = document.createElement('span');
    //     decrementButton.className = 'dec qtybtn';
    //     decrementButton.innerHTML = '<i class="fa fa-angle-left"></i>';
    //     quantityContainer.prepend(decrementButton);
        
    //     // Add the increment button after the input field
    //     var incrementButton = document.createElement('span');
    //     incrementButton.className = 'inc qtybtn';
    //     incrementButton.innerHTML = '<i class="fa fa-angle-right"></i>';
    //     quantityContainer.append(incrementButton);
        
    //     // Attach event listener to the buttons
    //     var buttons = document.querySelectorAll('.qtybtn');
    //     buttons.forEach(function(button) {
    //       button.addEventListener('click', function() {
    //         var buttonElement = this;
    //         var inputElement = buttonElement.parentNode.querySelector('input');
    //         var oldValue = parseFloat(inputElement.value);
    //         var newVal;
        
    //         if (buttonElement.classList.contains('inc')) {
    //           newVal = oldValue + 1;
    //         } else {
    //           // Don't allow decrementing below zero
    //           if (oldValue > 0) {
